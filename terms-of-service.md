...
- **"Content"** means any data, text, information, or other materials you create, upload, or store through the Service, including habit data, notes, categories, and profile information.
- **"Hakoi Plus"** and **"Hakoi Premium"** refer to paid subscription tiers offering additional features.
- **"Karma"** refers to the in-app gamification point system.
- **"Contract"** refers to the accountability feature allowing users to enter mutual habit commitments with other users.
...
- Use automated means (bots, scrapers, crawlers) to access, collect data from, or interact with the Service without our express written permission.
- Reverse engineer, decompile, disassemble, or attempt to derive the source code of the Service.
- Transmit any viruses, worms, defects, trojan horses, or other items of a destructive or harmful nature.
- Harass, abuse, stalk, threaten, or otherwise violate the rights of other users.
- Use the social features (Contracts, Leaderboard, Karma sharing, friend system) to bully, intimidate, or engage in toxic behavior toward other users.
- Manipulate or exploit the Karma system, Leaderboard rankings, or Contract system through fraudulent or dishonest means, including but not limited to: creating duplicate accounts to inflate Karma, falsifying habit completion data, artificially inflating Leaderboard rankings, or colluding with other users to game the scoring system.
- Upload or share Content that is defamatory, obscene, hateful, or otherwise objectionable through any user-facing fields (usernames, habit notes, etc.).
